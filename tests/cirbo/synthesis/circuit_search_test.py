...
def test_simple_operations():
    ...
    check_exact_circuit_size(8, tt, Basis.FULL)
    tt = [op.value for op in Operation][10:]
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # FIXME: https://github.com/SPbSAT/cirbo/issues/139
        # pytest.param(('0000', ""), id="output is constant False"),
        # pytest.param(('1111', ""), id="output is constant True"),
    ],
)
