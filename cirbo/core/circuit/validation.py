...
if tp.TYPE_CHECKING:
    from cirbo.core.circuit.circuit import Block, Circuit
    from cirbo.core.circuit.gate import Gate, Label
...
def check_circuit_has_no_cycles(circuit: 'Circuit') -> None:
    ...
    from cirbo.core.circuit.circuit import TraverseState
